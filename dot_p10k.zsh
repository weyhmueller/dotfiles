# Generated by Powerlevel10k configuration wizard on 2023-06-24 at 08:41 CEST.
...
#  typeset -g POWERLEVEL9K_VPN_IP_CONTENT_EXPANSION=
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|gif|(.*tun)|tailscale)[0-9]*|(zt.*)|(feth[0-9]{3})'
